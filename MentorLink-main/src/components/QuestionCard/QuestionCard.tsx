...
const QuestionCard = ({
  ...
  const safeTopic = topic?.trim() || "No topic provided";
  const safeDescription = description?.trim() || "No description available.";
  const safeTeacherName = teacherName?.trim() || "Unknown";
    ...
    <>
      ...
      <div className={styles.questionCard} onClick={() => setIsExpanded(true)}>
        <div className={styles.subjectHeader}>
          <span className={styles.subjectBadge}>{safeSubject}</span>
        </div>
        <div className={styles.infoSection}>
          <div className={styles.labelGroup}>
            <span className={styles.headingLabel}>Topic</span>
            <h3 className={styles.topicText}>{safeTopic}</h3>
          </div>
          <div className={styles.labelGroup}>
            <span className={styles.headingLabel}>Description</span>
            <p className={styles.truncatedDescription}>{safeDescription}</p>
            ...
            <div className={styles.modalBody}>
              {showFile ? (
                ...
                <div className={styles.viewContainer}>
                  <div className={styles.labelGroup}>
                    <span className={styles.headingLabel}>Topic</span>
                    <h2 className={styles.fullTopic}>{safeTopic}</h2>
                  </div>
                  <div
                  ...
                  >
                    <span className={styles.headingLabel}>Description</span>
                    <div className={styles.scrollArea}>
                      <p className={styles.fullDescription}>{safeDescription}</p>
